  ...
  <div class="flex flex-col items-center justify-center min-h-screen p-6 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
    <div class="w-full max-w-md">
      ...
      <div class="space-y-4">
        <NuxtLink
          to="/shop-select"
          class="group block w-full p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-2xl text-center text-xl font-semibold hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 touch-target"
        >
        ...
        <NuxtLink
          to="/staff/login"
          class="group block w-full p-6 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-2xl text-center text-xl font-semibold hover:from-purple-700 hover:to-purple-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 touch-target"
        >
          <div class="flex items-center justify-center gap-3">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
